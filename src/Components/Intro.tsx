  ...
  return (
    <div className="flex flex-col justify-center items-center text-center lg:text-start gap-10 lg:flex-row lg:justify-between">
      <div className="flex flex-col gap-4 h-full lg:w-[70%]">
        ...
        Ist IEEE International Conference on Sustainable Solutions in Engineering Technologies and Earth Science-ICSSETES-26
        </p>
        <div className="hidden lg:flex items-center space-x-2 lg:justify-start justify-center">
          <div className="text-red-800">
            <p className="font-semibold text">
              Organized by <br></br>Electronics and Communication Engineering Department
            </p>
            <p className="font-semibold texts">ITS Engineering College</p>
            <p className="text-sm">Knowledge Park III, Greater Noida, Uttar Pradesh, India, 201310.</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 lg:justify-start justify-center">
          <div className="text-blue-900">
            ...
            <p className="font-semibold texts">TWINTECH INTERNATIONAL UNIVERSITY COLLEGE OF TECHNOLOGY</p>
            <p className="font-semibold texts">64, Lebuh Bishop, George Town, 10200 George Town, Pulau Pinang, Malaysia.</p>
          </div>
        </div>
        ...
        <div className="flex space-x-5 text-2xl text-red-800 mt-4 items-center lg:justify-start justify-center">
          <a href="https://twitter.com/ITSengggn/" target="_blank" rel="noopener noreferrer" aria-label="icssetes twitter">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
          ...
          <a href="tel:+91-7835878146" aria-label="icssetes phone">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
          ...
          <a
            href="https://www.facebook.com/ITSengggn?mibextid=ZbWKwL"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="icssetes facebook"
          >
            <svg
              stroke="currentColor"
              fill="currentColor"
          ...
          <a href="mailto:dean.cse@its.edu.in" aria-label="icssetes mail">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
            ...
            <SwiperSlide >
              ...
              >
                <div className="flex h-full w-full cursor-grab active:cursor-grabbing object-cover">
                  <img
                    draggable="false"
                    alt="ICSSETES-26 conference highlights"
                    src="/image1.jpg"
                    width="3000"
                    height="2000"
                    decoding="async"
